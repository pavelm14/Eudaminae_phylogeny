...
- [Rename taxa](#1-rename-specimens-in-every-fasta-file)
  * [Reformat fasta sequences](11-multi--to-single-line-sequences-in-fasta-files)
- [Count loci per specimen](2-count-number-of-sequences-across-fasta-files)
- [Extract sequences](3-extract-sequences-of-interest-from-multiple-fasta-files)
  * [Count specimens per locus](31-count-the-number-of-specimens-per-locus)
- [Add missing sequences](4-add-missing-sequences-to-fasta-files)
